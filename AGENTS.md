...
| 글리프 그리기 | 4곳 — `0x8002E834` `0x8002E9EC` `0x8002EC58` `0x8002F090` |
...
| VRAM CLUT | **`(288,224)`** 16벌 — 적재기가 x·y 를 상수로 덮어쓴다(`0x8002c408`) |
...
글리프 칸을 882 → **1,764** 로 올린다. 바뀐 워드 34개.

| 자리 | 전 → 후 |
|---|---|
| `0x8002C420` | `slti v0,v0,0x11` → `0x21` — CLUT 높이 32 허용 |
